class ApplicationController < ActionController::Base
  ...
  # Код для, того чтобы новые поля в devise (ex: login) проходили через защиту params.
  # Работоспособность не проверена, т.к. ошибку в user с email из-за :validatable решить не удалось
